...
public class LinkTypeDao {
	...
	public List<LinkType> getListByPid(String pid) {
		String sql="SELECT * FROM t_link_type T WHERE T.DATA_STATE='1' AND T.pid=? ";
		List<LinkType> list = jdbcTemplate.query(sql,new Object[]{pid},new BeanPropertyRowMapper(LinkType.class));
		return list;
	}
	 ...
	 * @param linkType void
	 */
	public void update(final LinkType linkType) {
		String sql=	"UPDATE\n" +
						" t_link_type\n" + 
						"SET\n" + 
						"  pid = ?,\n" + 
	 ...
	 * @param linkType void
	 */
	public void save(final LinkType linkType) {
