...
var ctx = "${ctx}";
var topicData='[{"id":"67982d29-473e-41cd-bf60-c67488e3b0f6","text":"通知"}]';
...
<script type="text/javascript" charset="utf-8" src="${ctx}/resources/js-lib/ueditor-1.4.3.3/ueditor.all.min.js"> </script>
		...
		<form class="layui-form" action="${ctx}/sois/save" method="post">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<select name="topicId" id="topicId" lay-verify="required">
						<%--
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="articleTitle" required lay-verify="required"
	...
	<script>
		...
		layui.use(['form','upload'], function(){
		  ...
		  var topicArray=JSON.parse(topicData);
