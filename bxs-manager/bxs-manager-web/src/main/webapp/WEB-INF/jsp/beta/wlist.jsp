...
$(function(){
	...
	dgTable=$('#dgTable').datagrid({  
		...
		dgTable.datagrid('enableCellEditing').datagrid('gotoCell', {
            index: 0,
            field: 'id'
        });
...
<script type="text/javascript" src="${ctx}/resources/js-lib/jquery-easyui-1.4.3/datagrid-cellediting.js"></script>
