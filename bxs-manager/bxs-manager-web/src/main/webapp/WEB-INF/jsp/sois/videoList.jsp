...
var pageConfig = {
		listUrl:ctx+"/sois/getArticleList",
		editUrl:ctx+"/sois/videoEdit/",
		deleteUrl:ctx+'/sois/delete',
	    articleType:"7"
}
			...
			layui.use('table', function(){
			   ...
			   var tableIns =  table.render({
			    ...
			    ,cols: [[
			      ...
			      ,{field:'author', width:80, title: '作者', sort: false}
			  ...
			  table.on('tool(newsList)', function(obj){
			        ...
			        data = obj.data;
			        if(layEvent === 'edit'){
			        	location.href=pageConfig.editUrl+data.id;
	...
	<div class="admin-main">
		<form action="#" method="post">
			<blockquote class="layui-elem-quote">
				<a href="${ctx}/sois/videoAdd" class="layui-btn"> <i class="layui-icon">&#xe608;</i>
					添加警务视频
				</a>
